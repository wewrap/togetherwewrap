...
export const Contacts = () => {
    ...
    const [importantDates, setImportantDate] = useState<Array<ImportantDate>>([])
    const [email, setEmail] = useState<string>('')
    const [phoneNumber, setPhoneNumber] = useState<string>('')
    // const [address, setAddress] = useState<string>('') Make own PR
    ...
    (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const handleNameChange = handleChange(setFirstName);
        const handleNameChange = handleChange(setLastName);
